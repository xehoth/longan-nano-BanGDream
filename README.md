...
A rhythm game that implements a **subset** of BanG Dream in longan nano board.
This is project 4 in ShanghaiTech CS110 Computer Architecture Spring2021.  

## Compile & Run

Use PlatformIO to compile.

Before running the program on the board, launch the `tools/music/main.py` for music playing.
